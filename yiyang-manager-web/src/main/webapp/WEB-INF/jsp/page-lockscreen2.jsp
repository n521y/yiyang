			...
			<div class="row">
				...
				<div class="body-sign body-locked">
					<div class="center-sign">
						<div class="panel bk-bg-primary panel-sign">
							<div class="panel-body text-center bk-padding-off bk-wrapper">
								...
								<div class="bk-avatar bk-avatar120-halfdown">
									...
									<div class="bk-fg-info bk-fg-darken">
										<img src="assets/img/avatar1.jpg" alt="" class="img-circle bk-img-120 bk-border-primary bk-border-darken bk-border-3x" />
									</div>
								</div>
							</div>
							<div class="panel-body bk-bg-primary bk-padding-left-30 bk-padding-right-30 bk-avatar120-halfdown-after text-center">
