			...
			<div class="row">
				...
				<div class="main ">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="panel panel-default form-wizard" id="w1">
								<div class="panel-heading">
									<h6><i class="fa fa-tags bk-fg-warning"></i>Form Wizard</h6>									
								...
								<div class="panel-body panel-body-nopadding">
									<div class="wizard-tabs">
										<ul class="wizard-steps">
											...
											<li>
												<a href="#w1-confirm" data-toggle="tab" class="text-center bk-radius-right">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="panel form-wizard" id="w2">
								<div class="tabs tabs-primary">
									...
									<form class="form-horizontal" novalidate="novalidate">
										<div class="tab-content bk-noradius">
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="panel panel-default form-wizard" id="w5">
								<div class="panel-heading">
									<h6><i class="fa fa-tags bk-fg-warning"></i>Form Wizard</h6>									
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
								...
								<div class="panel-body">
									...
									<div class="progress progress-xs light progress-striped active">
