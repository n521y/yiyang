...
<html lang="en">
	...
	<head>
		...
		<title>UI Progress-bars | Fire - Admin Template</title>
						...
						<div class="col-md-12">
							<div class="panel panel-default bk-bg-white">
								...
								<div class="panel-body">
									...
									<div class="progress light progress-xl ">
										<div class="progress-bar progress-squared progress-bar-success" style="width: 15%">
											<span class="sr-only">15% Complete (success)</span>
										</div>
										<div class="progress-bar progress-squared progress-bar-warning" style="width: 45%">
											<span class="sr-only">45% Complete (warning)</span>
										</div>
										<div class="progress-bar progress-squared progress-bar-danger" style="width: 30%">
											<span class="sr-only">30% Complete (danger)</span>
										</div>
									</div>
									<div class="progress light progress-xl ">
										<div class="progress-bar progress-squared progress-bar-success" style="width: 30%">
											30%
										</div>
										<div class="progress-bar progress-squared progress-bar-warning" style="width: 25%">
											25%
										</div>
										<div class="progress-bar progress-squared progress-bar-danger" style="width: 40%">
											40%
										</div>
									</div>
									<div class="progress light progress-xl  progress-striped">
