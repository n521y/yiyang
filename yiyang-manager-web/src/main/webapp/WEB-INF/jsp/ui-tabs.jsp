...
<html lang="en">
	...
	<body>
				...
				<div class="main ">
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-indent"></i>Tabs</li>
							</ol>						
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs">
								<ul class="nav nav-tabs">
									<li class="active">
										<a href="#home" data-toggle="tab"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs">
								<ul class="nav nav-tabs text-right tabs-primary">
									<li class="active">
										<a href="#home7" data-toggle="tab"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
										<a href="#profile7" data-toggle="tab">Profile</a>
									</li>
								</ul>
								<div class="tab-content">
									<div id="home7" class="tab-pane active">
										<p>Home <code>.nav-tabs.nav-right</code></p>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitat.</p>
									</div>
									<div id="profile7" class="tab-pane">
										<p>Profile <code>.nav-tabs.nav-right</code></p>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitat.</p>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs tabs-bottom">
								<div class="tab-content">
									<div id="home13" class="tab-pane active">
										<p>Home</p>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitat.</p>
									</div>
								...
								<ul class="nav nav-tabs">
									<li class="active">
										<a href="#home13" data-toggle="tab"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
										<a href="#profile13" data-toggle="tab">Profile</a>
									</li>
								</ul>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs tabs-bottom tabs-primary">
								...
								<ul class="nav nav-tabs nav-right">
									<li class="active">
										<a href="#home14" data-toggle="tab"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
										<a href="#profile14" data-toggle="tab">Profile</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs">
								<ul class="nav nav-tabs nav-justified">
									<li class="active">
										<a href="#home10" data-toggle="tab" class="text-center"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
										<a href="#profile10" data-toggle="tab" class="text-center">Profile</a>
									</li>
								</ul>
								<div class="tab-content">
									<div id="home10" class="tab-pane active">
										<p>Home <code>.nav-tabs.nav-justified</code></p>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitat.</p>
									</div>
									<div id="profile10" class="tab-pane">
										<p>Profile <code>.nav-tabs.nav-justified</code></p>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitat.</p>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs tabs-bottom tabs-primary">
								<div class="tab-content">
									<div id="home8" class="tab-pane active">
										<p>Home <code>.nav-tabs.nav-justified</code></p>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitat.</p>
									</div>
								...
								<ul class="nav nav-tabs nav-justified">
									<li class="active">
										<a href="#home8" data-toggle="tab" class="text-center"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
										<a href="#profile8" data-toggle="tab" class="text-center">Profile</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs tabs-vertical tabs-left">
								<ul class="nav nav-tabs col-sm-3 col-xs-5">
									<li class="active">
										<a href="#home11" data-toggle="tab"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
										<a href="#profile11" data-toggle="tab">Profile</a>
									</li>
								</ul>
								<div class="tab-content">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs tabs-vertical tabs-right tabs-primary">
								<div class="tab-content">
									<div id="home12" class="tab-pane active">
										<p>Home</p>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitat.</p>
									</div>
								...
								<ul class="nav nav-tabs col-sm-3 col-xs-5">
									<li class="active">
										<a href="#home12" data-toggle="tab"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
										<a href="#profile12" data-toggle="tab">Profile</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs tabs-primary">
								<ul class="nav nav-tabs">
									<li class="active">
										<a href="#home1" data-toggle="tab"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs tabs-success">
								<ul class="nav nav-tabs">
									<li class="active">
										<a href="#home2" data-toggle="tab"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs tabs-warning">
								<ul class="nav nav-tabs">
									<li class="active">
										<a href="#home3" data-toggle="tab"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs tabs-danger">
								<ul class="nav nav-tabs">
									<li class="active">
										<a href="#home4" data-toggle="tab"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs tabs-info">
								<ul class="nav nav-tabs">
									<li class="active">
										<a href="#home5" data-toggle="tab"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
										<a href="#profile5" data-toggle="tab">Profile</a>
									</li>
								</ul>
								<div class="tab-content">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tabs tabs-dark">
								<ul class="nav nav-tabs">
									<li class="active">
										<a href="#home6" data-toggle="tab"><i class="fa fa-home"></i> Home</a>
									</li>
									<li>
										<a href="#profile6" data-toggle="tab">Profile</a>
									</li>
								</ul>
								<div class="tab-content">
									<div id="home6" class="tab-pane active">
										<p>Home</p>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitat.</p>
									</div>
		...
		<!-- Pages JS -->
		<script src="assets/js/pages/ui-tabs.js"></script>
