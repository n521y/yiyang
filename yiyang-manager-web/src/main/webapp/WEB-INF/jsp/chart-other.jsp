...
<html lang="en">
	...
	<head>
		...
		<title>Chart Other | Fire - Admin Template</title>
				...
				<div class="main ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-bar-chart-o red"></i>Radar</h6>
								...
								<div class="panel-body text-center">
									<canvas id="radar" height="250" width="250"></canvas>	
								</div>
							</div>
                        </div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-bar-chart-o red"></i>Polar Area</h6>
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
								...
								<div class="panel-body text-center">
									<canvas id="polarArea" height="250" width="250"></canvas>
								</div>
							</div>
                        </div>
                    </div>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="panel panel-default">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-bar-chart-o"></i>Just Gage</h6>
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
					...
					<div class="row">					
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-bar-chart-o"></i>Easy Pie Charts</h6>
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
								...
								<div class="panel-body bk-padding-top-20">
									<div class="row clearfix">
										<div class="chart col-sm-3 text-center">
											<div class="percentage" data-percent="55" data-bar-color="#2980b9"></div>
										</div>
										<div class="chart col-sm-3 text-center">
											<div class="percentage" data-percent="46" data-bar-color="#2980b9"></div>
										</div>            
										<div class="chart col-sm-3 text-center">
											<div class="percentage" data-percent="92" data-bar-color="#2980b9"></div>
										</div>
										<div class="chart col-sm-3 text-center">
