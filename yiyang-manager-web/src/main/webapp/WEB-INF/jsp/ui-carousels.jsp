...
<html lang="en">
	...
	<head>
		...
		<title>UI Carousels | Fire - Admin Template</title>
	...
	<body>
				...
				<div class="main ">
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-play"></i>Carousels</li>
							</ol>						
						</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
							<div class="owl-carousel" data-plugin-carousel data-plugin-options='{ "autoPlay": 3000, "items": 6, "itemsDesktop": [1199,4], "itemsDesktopSmall": [979,3], "itemsTablet": [768,2], "itemsMobile": [479,1] }'>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo1.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo2.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo3.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo4.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo5.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo6.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo7.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo8.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo9.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo10.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo11.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo12.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo13.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo14.jpg" alt=""></div>
								<div class="item spaced"><img class="img-thumbnail" src="assets/img/gallery/photo15.jpg" alt=""></div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">							
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6><i class="fa fa-film"></i>Single Item</h6>									
								...
								<div class="panel-body text-center">
									<div class="owl-carousel" data-plugin-carousel data-plugin-options='{ "items": 1, "autoHeight": true }'>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo1.jpg">
										</div>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo2.jpg">
										</div>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo3.jpg">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6><i class="fa fa-film"></i>Navigation</h6>									
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
								...
								<div class="panel-body text-center">
									<div class="owl-carousel" data-plugin-carousel data-plugin-options='{ "items": 1,  "navigation": true, "pagination": false }'>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo4.jpg">
										</div>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo5.jpg">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6><i class="fa fa-film"></i>Autoplay</h6>									
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
								...
								<div class="panel-body text-center">
									<div class="owl-carousel" data-plugin-carousel data-plugin-options='{ "autoPlay": 5000, "items": 1,  "navigation": false, "pagination": true }'>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo6.jpg">
										</div>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo7.jpg">
										</div>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo8.jpg">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6><i class="fa fa-film"></i>Controls Disabled</h6>									
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
								...
								<div class="panel-body">
									<div class="owl-carousel" data-plugin-carousel data-plugin-options='{ "autoPlay": 2000, "items": 1,  "navigation": false, "pagination": false }'>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo9.jpg">
										</div>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo10.jpg">
										</div>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo11.jpg">
										</div>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo12.jpg">
										</div>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo13.jpg">
										</div>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo14.jpg">
										</div>
										<div class="item">
											<img alt="" class="img-responsive" src="assets/img/gallery/photo15.jpg">
										</div>
									</div>
								</div>
							</div>
		...
		<!-- Pages JS -->
		<script src="assets/js/pages/ui-carousels.js"></script>
