								...
								<div class="panel-body bk-bg-very-light-gray">
									<div class="mailbox-email-header">
										<h3 class="mailbox-email-subject bk-fg-primary">
											Released Fire Bootstrap Admin!
										</h3>								
										<p>From <a href="http://naztemplate.com">Naztemplate</a> to <a href="#">You</a>, started on November 01, 2014</p>
									</div>
								</div>
							</div>						
							<div class="panel">
								<div class="panel-heading bk-bg-white mailbox-btn-action bk-padding-top-20 bk-padding-bottom-20">
									<span class="panel-actions text-right">
									...
									<span class="item-action-group text-left">
										<a class="item-action fa fa-mail-reply" href="#message-reply"></a>
									...
									<span class="item-action-group text-left">
										<a class="item-action fa fa-print" href="#"></a>									
									</span>									
								</div>	
							...
							<div class="panel" id="message-reply">								
								<div class="panel-body message-reply">
									<div class="mailbox-compose" data-mailbox data-mailbox-view="compose">											
										...
										<div class="text-right bk-padding-left-10">
