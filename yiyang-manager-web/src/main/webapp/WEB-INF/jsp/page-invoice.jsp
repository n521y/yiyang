...
<html lang="en">
	...
	<head>
		...
		<title>Invoice | Fire - Admin Template</title>
					...
					<div class="invoice">
						<div class="row header">
							...
							<div class="col-sm-4">							
								<div class="panel panel-body bk-bg-white">
									<h5><em>Details:</em></h5>
									<p>Invoice No.:<strong> 1258/MAR/15</strong></p>
									<p>Date: March 27, 2015</p>							
							...
							<div class="panel-body bk-padding-bottom-40">
								...
								<div class="row">
									<div class="col-lg-4 col-lg-offset-4 col-sm-5 col-sm-offset-2 recap pull-right">
										...
										<a href="" class="btn btn-default" onclick="javascript:window.print();"><i class="fa fa-print"></i> Print</a>
										<a href="" class="btn btn-primary"><i class="fa fa-usd"></i> Proceed to Payment</a>
									</div>
								</div>
							</div>
						</div>	
