						...
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<div class="panel">
								<div class="panel-body bk-bg-very-light-gray mailbox-menu">
									<a href="mailbox-compose.jsp" class="btn btn-primary btn-block">Compose</a>
									<ul>
										<li>
											<a href="mailbox-inbox.jsp">Inbox<span class="label label-primary">165</span></a>
										</li>
										<li>
											<a href="#">Stared</a>
										</li>
										...
										<li>
											<a href="#">Important<span class="label label-info">7</span></a>
										</li>
										<li>
											<a href="#">Draft<span class="label label-warning">3</span></a>
										</li>
										<li>
											<a href="#"></i>Trash</a>
										</li>
										...
										<li>
											<a href="#">Work <span class="ball pink"></span></span></a>
										</li>
										<li>
											<a href="#">Private <span class="ball green"></span></a>
										</li>
										<li>
											<a href="#">Clients <span class="ball blue"></span></a>
										</li>
										<li>
											<a href="#">Travel <span class="ball orange"></span></a>
										</li>										
									</ul>									
								</div>									
							</div>							
								...
								<div class="panel-body">
									<form class="form-horizontal bk-margin-top-10" role="form">
										...
										<div class="mailbox-compose bk-padding-bottom-20 bk-margin-left-5">
											<button type="button" class="btn btn-primary bk-margin-top-5"><i class="fa fa-send-o"></i> Send</button>
											<button type="button" class="btn btn-default bk-margin-top-5"><i class="fa fa-times"></i> Discard</button>
											<button type="button" class="btn btn-default bk-margin-top-5"><i class="fa fa-file-text-o"></i> Draft</button>
											<button type="button" class="btn btn-default bk-margin-top-5"><i class="fa fa-paperclip"></i> Attach</button>
										</div>
									</form>																	
								</div>
							</div>	
