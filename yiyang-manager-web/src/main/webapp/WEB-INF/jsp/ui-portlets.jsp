...
<html lang="en">
	...
	<head>
		...
		<title>UI Portlets | Fire - Admin Template</title>
	...
	<body>
		...
		<div class="container-fluid content">	
			<div class="row">
				...
				<div class="main ">
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-arrows"></i>Portlets</li>
							</ol>						
						</div>
					...
					<p>
						<button id="portletRefresh" type="button" class="btn btn-default"><i class="fa fa-refresh"></i> Refresh</button>
						<button id="portletReset" type="button" class="btn btn-default"><i class="fa fa-undo"></i> Reset</button>
					</p>
					<br />
					<div class="row">						
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" data-plugin-portlet id="portlet-1">								
							<div class="panel panel-default" id="panel-1" data-portlet-item>
								<div class="panel-heading portlet-handler">
									<h6><i class="fa fa-signal"></i>Panel Default</h6>
							...
							<div class="panel panel-primary" id="panel-2" data-portlet-item>
								<div class="panel-heading portlet-handler">
									<h6><i class="fa fa-signal"></i>Panel Primary</h6>
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" data-plugin-portlet id="portlet-2">							
							<div class="panel panel-success" id="panel-3" data-portlet-item>
								<div class="panel-heading portlet-handler">
									<h6><i class="fa fa-signal"></i>Panel Success</h6>
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
							...
							<div class="panel panel-info" id="panel-4" data-portlet-item>
								<div class="panel-heading portlet-handler">
									<h6><i class="fa fa-signal"></i>Panel Info</h6>
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" data-plugin-portlet id="portlet-3">
							<div class="panel panel-warning" id="panel-5" data-portlet-item>
								<div class="panel-heading portlet-handler">
									<h6><i class="fa fa-signal"></i>Panel Warning</h6>
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
							...
							<div class="panel panel-danger" id="panel-6" data-portlet-item>
								<div class="panel-heading portlet-handler">
									<h6><i class="fa fa-signal"></i>Panel Danger</h6>
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
		...
		<script src="assets/plugins/jquery-ui-touch-punch/js/jquery.ui.touch-punch.js"></script>
		<script src="assets/plugins/store-js/js/store.js"></script>		
		...
		<!-- Pages JS -->
		<script src="assets/js/pages/ui-portlets.js"></script>
