						...
						<div class="col-sm-12">							
							<div class="panel panel-default bk-bg-white">
								...
								<div class="panel-body">
									<figure class="demo" id="xchart" style="height: 300px"></figure>
								</div>
							</div>						
						</div>					
					</div>
					...
					<div class="row">						
						...
						<div class="col-sm-6">							
							<div class="panel panel-default bk-bg-white">
								...
								<div class="panel-body">
									<figure class="demo" id="xchart-line" style="height: 300px"></figure>
								</div>
							</div>						
						</div>					
					</div>
					...
					<div class="row">						
						<div class="col-sm-6">							
							<div class="panel panel-default bk-bg-white">
								...
								<div class="panel-body">
									<figure class="demo" id="xchart-points" style="height: 300px"></figure>
								</div>
							</div>						
						</div>						
						<div class="col-sm-6">							
							<div class="panel panel-default bk-bg-white">
								...
								<div class="panel-body">
									<figure class="demo" id="xchart-errorBars" style="height: 300px"></figure>
								</div>
							</div>						
						</div>					
					</div>										
