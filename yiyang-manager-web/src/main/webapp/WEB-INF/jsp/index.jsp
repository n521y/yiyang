...
<html lang="en">
	...
	<head>
		...
		<script src="assets/plugins/chart-master/js/echarts.js"></script>
	</head>
					...
					<div class="userbox">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<div class="profile-info">
								...
								<span class="role"><i class="fa fa-circle bk-fg-success"></i> 角色</span>
							</div>			
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li>
									<a href="http://localhost:8081/yiyang?page=page-profile"><i class="fa fa-user"></i> 个人信息</a>
								</li>
								<li>
								...
								<li>
									<a href="http://localhost:8081/yiyang?page=page-login"><i class="fa fa-power-off"></i> 登陆</a>
								</li>
							</ul>
						</div>						
					</div>
						...
						<div class="sidebar-menu">						
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-sidebar">
									...
									<li class="active">
										<a href="http://localhost:8081/yiyang?page=index">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											...
											<li><a href="http://localhost:8081/yiyang?page=page-activity"><span class="text"> Activity</span></a></li>
											<li><a href="http://localhost:8081/yiyang?page=page-timeline"><span class="text"> Timeline</span></a></li>
											<li><a href="http://localhost:8081/yiyang?page=page-invoice"><span class="text"> Invoice</span></a></li>
											<li><a href="http://localhost:8081/yiyang?page=page-pricing-tables"><span class="text"> Pricing Tables</span></a></li>
											<li><a href="http://localhost:8081/yiyang?page=page-login"><span class="text"> Login Page</span></a></li>
											<li><a href="http://localhost:8081/yiyang?page=page-register"><span class="text"> Register Page</span></a></li>
											<li><a href="http://localhost:8081/yiyang?page=page-recover-password"><span class="text"> Recover Password</span></a></li>
											<li><a href="http://localhost:8081/yiyang?page=page-lockscreen1"><span class="text"> Lock Screen 1</span></a></li>
											<li><a href="http://localhost:8081/yiyang?page=page-lockscreen2"><span class="text"> Lock Screen 2</span></a></li>
											<li><a href="http://localhost:8081/yiyang?page=page-404"><span class="text"> Page 404</span></a></li>
											<li><a href="http://localhost:8081/yiyang?page=page-500"><span class="text"> Page 500</span></a></li>
										</ul>
									</li>
									<li class="nav-parent">
										<a>
				...
				<div class="main ">
							...
							<div class="panel-body">
								<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
									<div class="panel bk-widget bk-border-off">
										...
										<div class="panel-body text-left bk-bg-white bk-padding-top-7 bk-padding-bottom-7">
											<div id="niu1" style="width: 400px;height:300px; margin: -30px;"></div>
										</div>
									</div>
								</div>
								<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
									<div class="panel bk-widget bk-border-off">
										...
										<div class="panel-body text-left bk-bg-white bk-padding-top-7 bk-padding-bottom-7">
											<div id="niu2" style="width: 400px;height:300px; margin: -30px;"></div>
										</div>
									</div>
								</div>
								<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
									<div class="panel bk-widget bk-border-off">
										...
										<div class="panel-body text-left bk-bg-white bk-padding-top-7 bk-padding-bottom-7">
											<div id="niu3" style="width: 400px;height:300px; margin: -30px;"></div>
										</div>
									</div>
								</div>
							</div>
					...
					<script type="text/javascript">
                        function loadOneColumn() {
                            console.log("niunnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn");
                            var myChart = echarts.init(document.getElementById('niu2'));
                            // 显示标题，图例和空的坐标轴
                            myChart.setOption({
                            ...
                            $.ajax({
                                type: 'get',
                                url: '/users/querryCharts',//请求数据的地址
                                dataType: "json",        //返回数据形式为json
                                success: function (data) {
                                    //请求成功时执行该函数内容，result即为服务器返回的json对象
                                    $.each(data.list, function (index, item) {
                                        names.push(item.nameFen);    //挨个取出类别并填入类别数组 
                                        brower.push({
                                            name: item.nameFen,
                                            value: item.countFen
                                        });
					...
					<script type="text/javascript">
                        ...
                        var myChart1 = echarts.init(document.getElementById('niu1'));

                        var myChart3 = echarts.init(document.getElementById('niu3'));
