...
<html lang="en">
	...
	<body>
				...
				<div class="main ">
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-square-o"></i>Lightbox</li>
							</ol>						
						</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6><i class="fa fa-fire bk-fg-danger"></i>Single Image</h6>									
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
									<p>Three simple popups with different scaling settings.</p>
								</div>
								<div class="panel-body bk-padding-bottom-50">
									<div class="row">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<h5 class="text-semibold bk-fg-inverse text-uppercase">Default</h5>
											<a href="assets/img/gallery/photo6.jpg" data-plugin-lightbox data-plugin-options='{ "type":"image" }' title="Caption. Can be aligned it to any side and contain any HTML.">
												<img class="img-responsive" src="assets/img/gallery/photo6.jpg" width="145" />
											</a>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<h5 class="text-semibold bk-fg-inverse text-uppercase">Fits (Horz/Vert)</h5>
											<a class="image-popup-vertical-fit" href="assets/img/gallery/photo5.jpg" title="Caption. Can be aligned it to any side and contain any HTML.">
												<img class="img-responsive" src="assets/img/gallery/photo5.jpg"  width="145" />
											</a>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<h5 class="text-semibold bk-fg-inverse text-uppercase">Effects</h5>
											<a class="image-popup-no-margins" href="assets/img/gallery/photo4.jpg">
												<img class="img-responsive" src="assets/img/gallery/photo4.jpg" width="75" />
											</a>
											<p>No gaps, zoom animation, close icon in top-right corner.</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6><i class="fa fa-fire bk-fg-danger"></i>Dialog with CSS animation</h6>									
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<a class="bk-margin-top-10 bk-margin-bottom-10 popup-with-zoom-anim btn btn-default" href="#small-dialog">Open with fade-zoom animation</a>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<a class="bk-margin-top-10 bk-margin-bottom-10 popup-with-move-anim btn btn-default" href="#small-dialog">Open with fade-slide animation</a>
										</div>
									</div>
									<!-- Dialog -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6><i class="fa fa-fire bk-fg-danger"></i>Popup with video or map</h6>									
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<a class="bk-margin-top-10 bk-margin-bottom-10 popup-youtube btn btn-default" href="http://www.youtube.com/watch?v=0O2aH4XLbto">Open YouTube Video</a>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<a class="bk-margin-top-10 bk-margin-bottom-10 popup-vimeo btn btn-default" href="https://vimeo.com/45830194">Open Vimeo Video</a>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<a class="bk-margin-top-10 bk-margin-bottom-10 popup-gmaps btn btn-default" href="https://www.google.com/maps/search/Melbourne,+Victoria,+Australia/@51.5237478,-0.158435,17z">Open Google Map</a>
										</div>
									</div>
									<hr />
									<div class="row">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<a class="popup-youtube" href="http://www.youtube.com/embed/S05TvApB3vc">Open YouTube Video</a>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<a class="popup-vimeo" href="https://vimeo.com/45830194">Open Vimeo Video</a>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<a class="popup-gmaps" href="https://www.google.com/maps/search/Melbourne,+Victoria,+Australia/@51.5237478,-0.158435,17z">Open Google Map</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6><i class="fa fa-fire bk-fg-danger"></i>Gallery</h6>									
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
									<p>Check the examples file <code>ui-lightbox.js</code> for more information.</p>
								</div>
								<div class="panel-body">
									...
									<div class="popup-gallery">
										<a class="pull-left" href="assets/img/gallery/photo1.jpg" title="Project 1">
											<div class="img-responsive">
												<img src="assets/img/gallery/photo1.jpg" width="105" />
											</div>
										</a>
										<a class="pull-left" href="assets/img/gallery/photo2.jpg" title="Project 2">
											<div class="img-responsive">
												<img src="assets/img/gallery/photo2.jpg" width="105" />
											</div>
										</a>
										<a class="pull-lef" href="assets/img/gallery/photo3.jpg" title="Project 3">
											<div class="img-responsive">
												<img src="assets/img/gallery/photo3.jpg" width="105" />
											</div>
										</a>
										<a class="pull-left" href="assets/img/gallery/photo4.jpg" title="Project 4">
											<div class="img-responsive">
												<img src="assets/img/gallery/photo4.jpg" width="105" />
											</div>
										</a>
										<a class="pull-left" href="assets/img/gallery/photo5.jpg" title="Project 5">
											<div class="img-responsive">
												<img src="assets/img/gallery/photo5.jpg" width="105" />
											</div>
										</a>
										<a class="pull-left" href="assets/img/gallery/photo6.jpg" title="Project 6">
											<div class="img-responsive">
												<img src="assets/img/gallery/photo6.jpg" width="105" />
											</div>
										</a>
									</div>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6><i class="fa fa-fire bk-fg-danger"></i>Form</h6>									
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
								...
								<div class="panel-body">
									...
									<form id="demo-form" class="white-popup-block mfp-hide form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<textarea rows="5" class="form-control" placeholder="Comments" required></textarea>
											</div>
										</div>
										<div class="row">
		...
		<!-- Pages JS -->
		<script src="assets/js/pages/ui-lightbox.js"></script>
