				...
				<div class="main ">
						...
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-indent red"></i>Simple Pricing Table</h6>							
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
								</div>
								<div class="panel-body bk-bg-very-light-gray bk-padding-top-30 bk-padding-bottom-40">									
									<div class="price-table">									
										<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 bk-margin-bottom-20">
											<ul>
												<li class="header bk-fg-primary">BASIC</li>								
												...
												<li>5 BONUS EVERY MONTH</li>                              
												<li class="select"><a class="btn btn-sm btn-default" href="page-pricing-tables.jsp#">BUY NOW</a></li>
											</ul>
										</div>								
										<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 bk-margin-bottom-20">
											<ul class="discount">
												<div class="label label-warning">DISCOUNT 70%</div>
												<li class="header bk-fg-primary">STANDART</li>								
										...
										<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 bk-margin-bottom-20">
											<ul>								
												<li class="header bk-fg-primary">PREMIUM</li>								
										...
										<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 bk-margin-bottom-20">
											<ul>
												<li class="header bk-fg-primary">PROFESSIONAL</li>								
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-indent red"></i>Advance Pricing Table</h6>							
									<div class="panel-actions">
										<a href="#" class="btn-minimize"><i class="fa fa-caret-up"></i></a>
										<a href="#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
								</div>
								<div class="panel-body bk-bg-very-light-gray bk-padding-top-60 bk-padding-bottom-40">
									<div class="pricing-table">
										<div class="pricing-wrap">
											<div class="plan bk-padding-left-10">
												...
												<div class="bk-padding-left-40">
													<a class="btn btn-sm btn-warning" href="page-pricing-tables.jsp#">PURCHASE</a>
												</div>
											</div>
										</div>
