...
<html lang="en">
	...
	<head>
		...
		<title>Timeline | Fire - Admin Template</title>
	...
	<body>
				...
				<div class="main">
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-sitemap"></i>Timeline</li>
							</ol>						
						</div>
					...
					<div class="row">
						<div class="timeline">
							<div class="tm-body">
								<div class="tm-title">
									<h3 class="h5 text-uppercase">March 2015</h3>
								</div>
								<ol class="tm-items">
									<li>
										<div class="tm-info">
											...
											<time class="tm-datetime" datetime="2015-03-27 09:34">
												<div class="tm-datetime-date bk-bg-white bk-radius text-center bk-padding-5">3 months ago.</div>
												<div class="tm-datetime-time">09:34 PM</div>
											</time>
										</div>
										<div class="tm-box">
											<p>
												Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  <span class="text-primary">#Responsive Admin</span>
											</p>
											<div class="tm-meta">
												<span>
													<i class="fa fa-user"></i> By <a href="#">John Smith Doe</a>
												</span>
												<span>
													<i class="fa fa-tag"></i> <a href="#">Awesome Design</a>
												</span>
												<span>
													<i class="fa fa-comments"></i> <a href="#">1452 Comments</a>
												</span>
												<span>
													<i class="fa fa-thumbs-up"></i> <a href="#">2345 Peoples</a>
												</span>
											</div>
										</div>
									</li>
									<li>
										<div class="tm-info">
											...
											<time class="tm-datetime" datetime="2015-03-15 08:19">
												<div class="tm-datetime-date bk-bg-white bk-radius text-center bk-padding-5">3 months ago.</div>
												<div class="tm-datetime-time">08:19 PM</div>
											</time>
										</div>
										<div class="tm-box">
											<p>
									...
									<li>
										<div class="tm-info">
											...
											<time class="tm-datetime" datetime="2015-02-02 08:27">
												<div class="tm-datetime-date bk-bg-white bk-radius text-center bk-padding-5">4 months ago.</div>
												<div class="tm-datetime-time">08:27 PM</div>
											</time>
										</div>
										<div class="tm-box">
											<p>
											...
											<blockquote class="primary">
												...
												<small><a href="index.jsp">Fire Admin</a>
												</small>
											</blockquote>
								...
								<div class="tm-title">
									<h3 class="h5 text-uppercase">Dec 2014</h3>
								</div>
								<ol class="tm-items">
									<li>
										<div class="tm-info">
											...
											<time class="tm-datetime" datetime="2014-12-25 07:45">
												<div class="tm-datetime-date bk-bg-white bk-radius text-center bk-padding-5">5 months ago.</div>
												<div class="tm-datetime-time">07:45 PM</div>
											</time>
										</div>
										<div class="tm-box">
											<p>
											...
											<div class="thumbnail-gallery">
												<a class="img-thumbnail" href="assets/img/gallery/photo9.jpg">
													<img width="215" src="assets/img/gallery/photo9.jpg">
													<span class="zoom">
														<i class="fa fa-search"></i>
													</span>
												</a>
												<a class="img-thumbnail" href="assets/img/gallery/photo10.jpg">
													<img width="215" src="assets/img/gallery/photo10.jpg">
													<span class="zoom">
														<i class="fa fa-search"></i>
													</span>
												</a>
												<a class="img-thumbnail" href="assets/img/gallery/photo11.jpg">
													<img width="215" src="assets/img/gallery/photo11.jpg">
													<span class="zoom">
														<i class="fa fa-search"></i>
													</span>
												</a>
									...
									<li>
										<div class="tm-info">
											...
											<time class="tm-datetime" datetime="2014-12-15 14:25">
												<div class="tm-datetime-date bk-bg-white bk-radius text-center bk-padding-5">5 months ago.</div>
												<div class="tm-datetime-time">14:25 AM</div>
											</time>
										</div>
										<div class="tm-box">
											<p>
											...
											<div class="video-container">
												<iframe width="850" height="400" src="http://www.youtube.com/embed/S05TvApB3vc" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 				
											 </div>
											<div class="tm-meta">
												<span>
													<i class="fa fa-user"></i> By <a href="#">John Smith Doe</a>
		...
		<!-- Pages JS -->
		<script src="assets/js/pages/page-timeline.js"></script>
